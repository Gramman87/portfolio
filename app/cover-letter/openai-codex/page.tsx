  ...
  return (
    <LetterDoc
      ...
      paragraphs={[
        ...
        "I want to own products end to end, from conception through launch and iteration, and I learn by putting things in front of real users. Five-plus years of production engineering keep me honest about code quality, testing, and performance, and I care about reframing problems rather than just optimizing the existing workflow. I work in TypeScript, React, Python, and Java, and I use agentic coding tools as a first-class part of how I build.",
        "I'm based in Evergreen, CO and available on-site in San Francisco Tuesday through Thursday to match the hybrid schedule. I'd welcome the chance to talk about building the developer tools that redefine how software gets made. Thank you for your consideration.",
      ]}
    />
  );
}
