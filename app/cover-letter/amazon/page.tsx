...
export default function AmazonCoverLetter() {
  return (
    <LetterDoc
      ...
      paragraphs={[
        "I'm applying for the Software Development Engineer II role on the DC Bridge team within AWS Infrastructure Services. I'm a backend engineer who builds and deploys production JVM services in the cloud, I'm based in the Denver metro and local to the role, and architecting scalable systems that model and track physical data-center infrastructure is exactly the kind of ownership-heavy, high-scale work I want to do.",
        "My core is Java on the backend and building for production. At Accenture Federal Services I modernized a legacy enterprise application end to end: containerizing it, implementing Java/Spring Boot microservices, migrating it onto OpenShift and Kubernetes, and building and consuming REST APIs across the architecture. I hold the line on API governance: versioning, backward compatibility, and security on public-facing surfaces, and I re-architected our CI/CD pipelines with parallelization and caching to cut deployment time 40%, which meant digging past the symptoms to the real bottlenecks.",
