  ...
  return (
    <LetterDoc
      ...
      paragraphs={[
        ...
        "I'm based in Evergreen, CO and available on-site in San Francisco Tuesday through Thursday to match the hybrid schedule, and I'm glad to travel to customer sites. I'd welcome the chance to talk about turning OpenAI's capabilities into production wins for your customers. Thank you for your consideration.",
      ]}
    />
  );
}
