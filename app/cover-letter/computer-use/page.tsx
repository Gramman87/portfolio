  ...
  return (
    <LetterDoc
      ...
      paragraphs={[
        ...
        "I'd bring genuine end-to-end ownership and a builder's instinct to the team. I'm based in Evergreen, CO and available on-site in San Francisco Tuesday through Thursday for the close, in-person work with researchers this role calls for. I'd welcome the chance to talk about what I could build on the Computer Use team. Thank you for your consideration.",
      ]}
    />
  );
}
