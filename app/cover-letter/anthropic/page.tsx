  ...
  return (
    <LetterDoc
      ...
      paragraphs={[
        ...
        "I'd bring genuine end-to-end ownership and a product-oriented mindset to whichever team I'm matched with. I'm based in Evergreen, CO and available on-site in San Francisco Tuesday through Thursday for the in-person collaboration this role calls for. I'd welcome the chance to talk about what I could build with the team. Thank you for your consideration.",
      ]}
    />
  );
}
