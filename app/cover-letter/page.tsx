  ...
  return (
    <LetterDoc
      ...
      paragraphs={[
        ...
        "I have 5+ years of production engineering, most recently at Accenture Federal Services, where I modernize legacy enterprise systems end-to-end: containerizing Java/Spring Boot services, migrating them onto OpenShift and Kubernetes, building and consuming REST APIs across a microservice architecture, and deploying them through the CI/CD pipeline. I re-architected our CI/CD pipelines to cut deployment time 40%, and I uphold API governance: versioning, backward compatibility, and security on public-facing surfaces.",
