  ...
  return (
    <LetterDoc
      ...
      paragraphs={[
        ...
        "I'll be straight about the boundary: I come from the application and evaluation side, so the serving internals (vLLM, SGLang, quantization) and fine-tuning methods (SFT, DPO, RFT) are areas I'd ramp into rather than claim today, and I'm genuinely excited to go deep. What I bring immediately is a builder's credibility with customers, evaluation rigor, and end-to-end ownership. I'm based in Evergreen, CO and ready to relocate to San Mateo and spend time on-site with customers. I'd welcome the chance to talk. Thank you for your consideration.",
      ]}
    />
  );
}
