  ...
  return (
    <LetterDoc
      ...
      paragraphs={[
        ...
        "I'd bring genuine technical depth, a builder's credibility, and the ability to meet customers where they are. I'm based in Evergreen, CO, available on-site in San Francisco Tuesday through Thursday, and glad to travel to customer sites. I'd welcome the chance to talk about helping enterprises get real value from Claude. Thank you for your consideration.",
      ]}
    />
  );
}
