...
export default function AmazonResume() {
  return (
    <ResumeDoc
      ...
      summary="Backend software engineer with 5+ years building and deploying production JVM services in the cloud. Modernizes enterprise systems end to end: Java/Spring Boot microservices and REST APIs on AWS, OpenShift, and Kubernetes, delivered through containerized CI/CD pipelines. Drives measurable results, including cutting deployment time 40% with parallelized, cached CI/CD, and digs into root causes rather than symptoms. Brings genuine end-to-end feature ownership and cross-functional delivery, sharpened by 13+ years leading $80M+ programs and mentoring teams, plus self-directed depth in agentic AI. Comfortable owning ambiguous features from design through deployment."
      strengths={[
        ...
        "Build & Deploy: containerization, Kubernetes/OpenShift, CI/CD pipelines, root-cause debugging, secure secrets management (HashiCorp Vault)",
